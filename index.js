...
// const fs = require('fs/promises'); // fs.promises は不要になったためコメントアウト
        ...
        "contents": [
            ...
            },
            {
                ...
                "action": {
                    "type": "uri",
                    "label": "こころちゃん事務局(電話)",
                    "uri": `tel:${EMERGENCY_CONTACT_PHONE_NUMBER}` // 環境変数から動的に設定
                },
                "color": "#FFC0CB"
            }
        ]
...
app.listen(PORT, async () => {
    ...
    // loadConfig(); // 設定ファイルの読み込みは不要になったためコメントアウト
